...
const glossaryList = [{
    ...
    },
    {
        ...
        references: `The Kubernetes Authors , “Using Minikube to Create a Cluster,” Kubernetes, Aug. 01, 2023. https://kubernetes.io/docs/tutorials/kubernetes-basics/create-cluster/cluster-intro/ (accessed Aug. 31, 2023).`
    },
    {
        id: 39,
        term: "Kubectl",
    ...
    },
    {
        id: 41,
        term: "HCL",
        description: "HCL or HashiCorp Configuration Language is a JSON-like configuration language mainly used with Terraform to indicate environmental/infrastructure configuration changes. It has become more generalized to be used with multiple languages in other tools. It has more features than JSON as it addresses certain limitations of JSON, which is also a specification language widely adopted by the developer community.",
        references: `A. Bertram, “Introduction to HCL and HCL tooling,” Octopus Deploy, Jul. 21, 2021. https://octopus.com/blog/introduction-to-hcl-and-hcl-tooling (accessed Sep. 19, 2023).`
    },
    {
        id: 42,
        term: "Knatives",
        description: "This is a Kubernetes extension to enable native features of simplified and automated building, deployment tasks while provided support for serverless running of containers that is not by default supported by general Kubernetes without cloud provider integration.",
        references: `IBM, “What is Knative? | IBM,” www.ibm.com, 2023. https://www.ibm.com/topics/knative (accessed Sep. 17, 2023).`
    },
    {
        id: 43,
        term: "Kube Proxy",
        description: "Kube-poxy is a component located in every node of Kubernetes cluster that interacts with Services while providing IP address mapping to dynamic pods withing the node. It implements service/endpoint changes as Network Address Translation (NAT) rules, thereby transferring traffic between services to worker pods.",
        references: `A. Essam, “Kube-Proxy: What is it and How it Works,” Medium, Jul. 01, 2023. https://medium.com/@amroessameldin/kube-proxy-what-is-it-and-how-it-works-6def85d9bc8f (accessed Sep. 17, 2023).`
    },
    {
        id: 44,
        term: "Terraform Resource Graph",
        description: "This is a dependency graph generated by Terraform using the specified configurations which is used to generate terraform plans, and state changes. The building of graph uses graph theory to build an effective graph of connections between resources and update them in an optimal manner.",
        references: `A. Boyer, “Resource Graph | Terraform | HashiCorp Developer,” Resource Graph | Terraform | HashiCorp Developer, Feb. 24, 2023. https://developer.hashicorp.com/terraform/internals/graph (accessed Sep. 17, 2023).`
    },
    {
        id: 45,
        term: "Azure Service Principal ",
        description: "This is a form of role-based identify created for Azure to allows applications/services or automated services/tools to access other Azure resources with minimum required access privileges to perform intended actions.",
        references: `dbradish-microsoft, “Work with Azure service principals – Azure CLI,” learn.microsoft.com, Aug. 02, 2023. https://learn.microsoft.com/en-us/cli/azure/create-an-azure-service-principal-azure-cli (accessed Sep. 17, 2023).`
    },
    {
        id: 46,
        term: "Terraform null resource ",
        description: "Null resource is a provider plugin supported by Terraform to provide arbitrary execution of actions without depending on any infrastructure resource constraints. Generally, it is useful to execute custom scripts or commands to execute external actions. This resource only has a standard lifecycle, thus providing flexibility to perform arbitrary actions.",
        references: `T. Alves, “A reason to stop using the Terraform null_resource,” Medium, Mar. 09, 2023. https://medium.com/@thiagoalves/a-reason-to-stop-using-the-terraform-null-resource-51180b2339 (accessed Sep. 19, 2023).`
    },
    {
        id: 47,
        term: "KubeEdge",
        description: "This is an extension to Kubernetes to facilitate running and orchestrating native containerized applications for IoT devices. It provides infrastructure required to network, deploy and synchronize metadata between cloud and Edge/IoT platforms. Both cloud and Edge forms KubeEdge which are open source.",
        references: `KubeEdge Project Authors, “Why KubeEdge | KubeEdge,” kubeedge.io, Aug. 07, 2023. https://kubeedge.io/docs/ (accessed Sep. 17, 2023).`
    },
    {
        id: 48,
        term: "Ingress",
        description: "Ingress is a resource object in Kubernetes that allows network communication between external connections and internal services via network rule configurations. Routing rules and configurations, exposing services/endpoints, load balancers and any other publicly available resources can be configured through Ingress.",
        references: `A. Patel, “Kubernetes — Ingress Overview,” DevOps Mojo, Oct. 05, 2021. https://medium.com/devops-mojo/kubernetes-ingress-overview-what-is-kubernetes-ingress-introduction-to-k8s-ingress-b0f81525ffe2 (accessed Sep. 17, 2023).`
    },
    {
        id: 49,
        term: "Kube-bench",
        description: "As the name indicates, Kube-bench is a bench marking project to run tests and verify if Kubernetes deployment is secure and running as intended. This is an open-source project implemented in Go. The test files are in .yaml format which contains the test specification on what needs to be tested.",
        references: `M. Cuber, “AWS EKS and kube-bench,” Medium, May 26, 2022. https://marcincuber.medium.com/aws-eks-and-kube-bench-a7ae840f0f1 (accessed Sep. 17, 2023).`
    },
    {
        id: 50,
        term: "Kubernetes Helm ",
        description: "Kubernetes Helm is a package management tool for complete Kubernetes deployments that automates and version the deployment activities. It maintains a reusable package of configuration files starting from creation to deployment thereby reducing manual efforts on deployment lifecycle.",
        references: `J. Schmitt, “What is Helm? A complete guide,” CircleCI, Mar. 16, 2023. https://circleci.com/blog/what-is-helm/ (accessed Sep. 17, 2023).`
    }
];
